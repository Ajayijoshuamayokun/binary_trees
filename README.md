...
This was a collaborative project where we delved into the intricacies, benefits, and drawbacks of using trees as data structures. We gained insights into classifying trees and navigating through them. Throughout the project, we coded implementations for binary, binary search, AVL, and Max Binary Heap trees.

## Tests :heavy_check_mark:

* [tests](./tests): Directory containing test files for all tasks. Provided by ALX.

## Helper File :raised_hands:

* [binary_tree_print.c](./binary_tree_print.c): C function for visually appealing binary tree printing.

## Header File :file_folder:

* [binary_trees.h](./binary_trees.h): Header file comprising definitions and prototypes for all types and functions developed for the project.
...
| `112-array_to_bst.c`             | `bst_t *array_to_bst(int *array, size_t
...
## Authors
<details>
    <summary>Ajayi Joshua Mayokun</summary>
    <ul>
    <li><a href="https://www.github.com/ajayijoshuamayokun">Github</a></li>
    <li><a href="https://www.twitter.com/ajayijoshuamayokun">Twitter</a></li>
    <li><a href="mailto:ajayijoshuamayokun@gmail.com">e-mail</a></li>
    </ul>
</details>
